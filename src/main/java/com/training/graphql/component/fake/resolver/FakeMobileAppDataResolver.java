...
import com.training.graphql.datasource.fake.FakeMobileAppDataSource;
import com.training.graphql.generated.DgsConstants;
import com.training.graphql.generated.types.MobileApp;
import com.training.graphql.generated.types.MobileAppFilter;
...
public class FakeMobileAppDataResolver {
    ...
    public List<MobileApp> getMobileApps(@InputArgument(name = "mobileAppFilter", collectionType = MobileAppFilter.class)
        ...
        if (!mobileAppFilter.isPresent()) return FakeMobileAppDataSource.MOBILE_APP_LIST;

        return FakeMobileAppDataSource.MOBILE_APP_LIST.stream().filter(
                        mobileApp -> matchFilter(mobileAppFilter.get(), mobileApp)
